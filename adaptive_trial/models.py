"""
Data Models & Telemetry Definitions for AdaptiveTrial-Mind: O'Brien-Fleming & Pocock Interim Stopping Boundary.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "FDA Adaptive Clinical Trial Guidelines"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
