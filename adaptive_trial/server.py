"""
FastAPI REST API Server for AdaptiveTrial-Mind: O'Brien-Fleming & Pocock Interim Stopping Boundary.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="AdaptiveTrial-Mind: O'Brien-Fleming & Pocock Interim Stopping Boundary",
            description="Calculates Lan-DeMets alpha spending functions (O'Brien-Fleming vs Pocock) and evaluates conditional power for trial termination.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "adaptive-trial-interim-stopping", "domain": "Biostatistics", "version": "2.0.0-FRONTIER"}
