"""
Command Line Interface for Adaptive Trial Interim Stopping.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="adaptive-trial-interim-stopping", description="Adaptive Trial Interim Stopping")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  ADAPTIVE TRIAL INTERIM STOPPING")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Adaptive Trial Interim Stopping Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Adaptive Trial Interim Stopping API server on http://{args.host}:{args.port}")
