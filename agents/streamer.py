"""
Live WebSocket Distributed Component Telemetry Streamer for adaptive-trial-interim-stopping.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "adaptive-trial-interim-stopping", "event_type": event_type, "payload": data})
