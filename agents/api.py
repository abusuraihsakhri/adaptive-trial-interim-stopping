"""
FastAPI REST API Server for Adaptive Trial Interim Stopping.
"""
...
app = FastAPI(
    title="Adaptive Trial Interim Stopping API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "adaptive-trial-interim-stopping", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
