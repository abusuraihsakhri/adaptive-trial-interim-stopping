"""
Automated Pytest for adaptive-trial-interim-stopping Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    SimulationEngine,
    RegulatoryEngine,
    AdaptivetrialinterimstoppingEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = AdaptivetrialinterimstoppingEnrichmentSuite()
